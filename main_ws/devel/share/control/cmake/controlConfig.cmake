...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/hjm/main_ws/src/control)
  set(control_DEVEL_PREFIX /home/hjm/main_ws/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/hjm/main_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'hjm <hjm@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hjm/main_ws/src/control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hjm/main_ws/devel/lib;/home/hjm/main_ws/devel/lib;/home/hjm/slam_ws/devel/lib;/home/hjm/lidar_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;tf2;tf2_ros")
